        ...
        <ScrollView contentContainerStyle={styles.container}>
            <View style={styles.imageContainer}>
                ...
                <View style={styles.formContainer}>
                    ...
                    <AppText variant='LoginText' style={{ color: value.color.white }}>Sign In</AppText>
                    ...
                    <ScrollView>
                        ...
                        {phoneError ? (
                            <AppText variant='smallText' style={{ color: value.color.white, marginTop: -10 }}>
                                {phoneError}
                            </AppText>
                        ) : null}
                    ...
                    <AppRow alignItems='flex-end' justifyContent='flex-end'>
                        ...
                        <TouchableOpacity>
                            <AppText
                                variant='smallText'
                                style={{ textDecorationLine: 'underline', marginTop: 5, color: value.color.white }}
                            >
                                Forgot PIN?
                            </AppText>
                        </TouchableOpacity>
